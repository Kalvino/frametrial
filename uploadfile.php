...
if (($_FILES["fileToUpload"]["type"] == "image/gif")
 || ($_FILES["fileToUpload"]["type"] == "image/png")
  ...
  if (file_exists("upload/" . $_FILES["fileToUpload"]["name"]  && "upload/" . $_FILES["fileToUpload"]["size"] ))
{
echo $_FILES["file"]["name"] . " already exists. ";
header("location: adminoticeboard.php");
		exit();
}
else
{
...
echo "</table>";
  ...
  echo "Stored in: " . "C:/wamp/www/frametrial/upload/" . $_FILES["fileToUpload"]["name"].date("Y.m.d");
  exit();
  }
  }
else
  ...
  echo "File type must either be JPEG, GIF, or PNG and less than 20,000 kb";
  echo "<table border=\"1\">";
echo "<tr><td>Client Filename: </td>
   <td>" . $_FILES["fileToUpload"]["name"] . "</td></tr>";
echo "<tr><td>File Type: </td>
